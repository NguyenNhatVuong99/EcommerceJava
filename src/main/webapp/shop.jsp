    ...
    <body>
        ...
        <section class="women-banner spad">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-3">
                        <div class="product-large set-bg" data-setbg="./static/img/products/chel.jpg">
                            <h2>Chelsea</h2>
                            ...
                            <c:forEach var="item" items="${productList}">
                                ...
                                <div class="product-item" data-product-id="${item.id}">
                                    <div class="pi-pic">
                                        ...
                                        <ul>
                                            <li class="w-icon active add-to-cart" style="cursor:pointer"><a ><i class="icon_bag_alt"></i></a></li>
